<?php
/*
Plugin Name: Activities Plugin
Description: A plugin for activities
Author: Kristian Andersson
*/
...
function cptrr() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Activities', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Activities', 'text_domain' ),
